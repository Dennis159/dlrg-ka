            ...
            <?php
              if(isset($_POST['save_new']) OR isset($_POST['edit'])){
                ...
                if(isset($_POST['save_new'])){
                  $TOOL->query("INSERT INTO settings_stringtable (STR, text) VALUES ('$str','$LINK')");
                  $t = 'Hat einen Text mit dem key \"' . $str . '\" erstellt';
                  GD_fnc_logIt($_SESSION['uid'], $t, 1);
                }
                if(isset($_POST['edit'])){
                  $TOOL->query("UPDATE settings_stringtable SET text = '$LINK' WHERE STR = '$str'");
                  ...
                  <div class="modal-content">
                    <form method="post">
                      <div class="modal-header">
                        <h4 class="modal-title">Text bearbeiten</h4>
                      </div>
